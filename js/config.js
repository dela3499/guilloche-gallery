...
config.options = [
    ...
    [
        {parameter: "fixedRadius", values: [100]},
        {parameter: "rollingRadius", values: linspace(0.924533,0.9245336,100)},
        {parameter: "tracingRadius", values: [100]},
        {parameter: "tracingRadiusCycles", values: [5500]},
        {parameter: "tracingRadiusAmplitude", values: [0.3]},
        {parameter: "multiplier", values: [1000]},
    ...
    [
        ...
        {parameter: "tracingRadius", values: linspace(15,150,100)},
    ...
    [
        ...
        {parameter: "tracingRadiusAmplitude", values: linspace(0,2,100)},
        {parameter: "multiplier", values: [1]},
        {parameter: "nPoints", values: [8002]},
        {parameter: "sidePercentage", values: linspace(0.9,0.7,100)}
    ],
    [
        {parameter: "fixedRadius", values: [100]},
        {parameter: "rollingRadius", values: [0.005]},
        {parameter: "tracingRadius", values: [50]},
        {parameter: "tracingRadiusCycles", values: linspace(4.8,5.2,100)},
    ...
    [
        {parameter: "fixedRadius", values: [100]},
        {parameter: "rollingRadius", values: linspace(0.01630630,0.016306311,100)},
    ...
    [
        ...
        {parameter: "tracingRadius", values: linspace(100,200,101)},
    ...
    [
        {parameter: "fixedRadius", values: linspace(106,106.2,101)},
        {parameter: "rollingRadius", values: [0.267]},
        {parameter: "tracingRadius", values: [90]},
    ...
    [
        {parameter: "fixedRadius", values: linspace(50.18991990,50.1899205,101)},
        {parameter: "rollingRadius", values: [0.267]},
        {parameter: "tracingRadius", values: [90]},
        {parameter: "tracingRadiusCycles", values: [5]},
        {parameter: "tracingRadiusAmplitude", values: [0.0]},
    ...
    [
        {parameter: "fixedRadius", values: linspace(100.00002675,100.0000268,50)},
        {parameter: "rollingRadius", values: [0.267]},
        {parameter: "tracingRadius", values: [90]},
        {parameter: "tracingRadiusCycles", values: [4003]},
        {parameter: "tracingRadiusAmplitude", values: linspace(0,.2,50)},
        {parameter: "multiplier", values: [28026.114]},
        {parameter: "nPoints", values: [10000.0]}
    ],
    [
        {parameter: "fixedRadius", values: linspace(155.01,155.05,101)},
        {parameter: "rollingRadius", values: [0.267]},
